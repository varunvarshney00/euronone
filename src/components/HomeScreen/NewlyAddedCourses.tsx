...
const LiveCourses = () => {
    ...
    const renderItem = ({ item }) => {
        return (
            ...
            <View style={{ height: 400, width: 300, borderRadius:8 }}>

                <LinearGradient colors={['#090D1A', '#03151F', 'black']} start={{ x: 0, y: 0.5 }} end={{ x: 0.5, y: 0 }} style={{ flex: 1, borderRadius:20}}>
    ...
    useEffect(() => {
        axios.get('https://api.euron.one/api/v1/courses/new')
            .then(response => {
    ...
    return (
        <View>
            <View style={styles.heading}>
                <Text style={styles.livecoursestext}>Newly Added Courses</Text>
